...
if __name__ == "__main__":
    ...
    parser.add_argument('-d', type=str, default='ns104_drecco', help="name of the database")
    parser.add_argument('-u', type=str, default='ns104', help="id of the database admin")
    parser.add_argument('-p', type=str, default='rxxta8ad', help="passwd of the database admin")
